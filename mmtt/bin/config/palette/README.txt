...
#
#  config_graphic  A directory of configuration files with parameters
#                  specifying the graphical behaviours that can
#                  be changed while Manifold is running.
#                  default.plt is the default configuration file.
#                  These files aren't meant to be edited manually,
#                  they are normally generated by Manifold under the
#                  control of its browser interface.
#
#  config_music    A directory of configuration files with parameters
#                  specifying the musical behaviours that can
#                  be changed while Manifold is running.
#                  default.plt is the default configuration file.
#                  These files aren't meant to be edited manually,
#                  they are normally generated by Manifold under the
#                  control of its browser interface.
#
#  *.mnf           Config files defining the setup of your synthesizers
#                  and other fundamental things that don't change after
#                  you've started Manifold.
#                  default.mnf is the default file, which reads
#                  several local_*.mnf files - you should edit the
#                  local_*.mnf files to specify your local config.
#
#  The format and meaning of the *.mnf files is described below.
#
#############################################################################

#############################################################################
#
# The config (.mnf) files here define things that will vary between
# machines and between various configurations of your VST synthesizers.
#
# The file default.mnf is the default configuration file read by Manifold.
# Normally, this file contains a single "include" line that reads the
# configuration file you actually want Manifold to use.  This makes it
# easy to switch the default configuration between various config files.
#
# The first word on each line can be:
#
#   include   The rest of the line is taken as a filename to read and
#             include at that point.
#
#   midi      The names of MIDI devices.  The second word on the line
#             is either "output" or "input".  The next word (possibly
#             preceeded by an "=") is the name of the MIDI device.
#
#   channel   Defines the synth that is attached to a MIDI channel.
#             The next word is the channel number, followed by the synth name.
#             
#   synth     Defines the name of a synth, which becomes the current synth
#             until the next "synth" line.
#
#   program   Defines a single patch/program on the current synth.
#             The next word is the program change#, followed by the
#             name of the patch.
#
# It's common for multiple instances of the same synthesizer
# to be attached to multiple channels.  This means that when you
# change a sound, Manifold can find a free channel for the new sound,
# so that the old channel/sound can continue to play without being cut off.
#
#############################################################################

#############################################################################
# That's the end of the description.
# The rest of the file below is just an example.
#############################################################################

midi output = 01. Internal MIDI
midi input = 02. Internal MIDI
# midi output = Midi Yoke:  1
# midi input = Midi Yoke:  2
# midi output = loopMidi Port 1
# midi input = loopMidi Port 2
...
sound 1 = Pad Gently Glitching Organ
sound 2 = Pad Motion Glory Wave
...
sound 1 = Lead Grandiose
sound 2 = Lead 07 SQ80 Attack Organ
sound 3 = Beatbox
...
sound 3 = Perc Cello Pizz Patch

soundset 6
sound 0 = Pad Glockenspiel resynthed
sound 1 = Perc Bell Menu
sound 2 = Perc Crystal Glass Mood
...
sound 1 = Pad Harmonic Ladder
sound 2 = Lead Female Overtone Singing mixed
sound 3 = Beatbox

soundset 1
sound 0 = Pad Bowed Cymbal Piano
sound 1 = Perc 2 Thai Gongs mixed RR8 4Vel
sound 2 = Perc Dumbbell Plate RR6 4Vel
sound 3 = Perc Caviar Cans split RR8 3-4 Vel

soundset 2
sound 0 = Lead Lamp Mallets RR4 3Vel
sound 1 = Lead Glass Mallets Round Robin 4
sound 2 = Lead Dragonfly Pluck
sound 3 = Lead FM Rhodes T

soundset 3
sound 0 = Pad Parsec
sound 1 = Pad 04 Sascha
sound 2 = Pad Active Galaxy
sound 3 = Perc Blue Sphere

soundset 4
sound 0 = Pad Cosmic Bell
sound 1 = Pad Lutcimbala Pluck
sound 2 = Lead Dragonfly Pluck
sound 3 = Pad M13 Cluster

soundset 5
sound 0 = Pad Katamorphic Pyrenees
sound 1 = Pad Ocean Science
sound 2 = Pad Pad Liquid Silver
sound 3 = Pad M13 Cluster

soundset 6
sound 0 = Bass 01 Pick Bass
sound 1 = Lead 09 Additive Dream Guitar
sound 2 = Lead Here Comes The Sun
sound 3 = Beatbox

soundset 7
sound 0 = Bass Deeper
sound 1 = Lead FM Rhodes T
sound 2 = Lead 02 Native American Flute
sound 3 = Beatbox
