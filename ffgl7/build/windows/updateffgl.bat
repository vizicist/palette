...
timeout /t 3 > nul
copy ..\..\binaries\x64\Debug\Palette.dll "c:\Program Files\Palette\ffgl7"
copy ..\..\binaries\x64\Debug\Palette.pdb "c:\Program Files\Palette\ffgl7"
copy ..\..\..\default\config\paramdefs.json "c:\Program Files\Palette\config\paramdefs.json"
copy ..\..\..\default\config\effects.json "c:\Program Files\Palette\config\effects.json"
