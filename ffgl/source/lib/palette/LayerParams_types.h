...
LayerParams_InitializeTypes() {
	...
	LayerParams_modeTypes.push_back("goat");
	...
	LayerParams_shapeTypes.push_back("polygon");
	LayerParams_shapeTypes.push_back("star");
	LayerParams_shapeTypes.push_back("diamond");
	LayerParams_shapeTypes.push_back("cross");
	LayerParams_shapeTypes.push_back("chevron");
	LayerParams_shapeTypes.push_back("arrow");
	LayerParams_shapeTypes.push_back("heart");
	LayerParams_shapeTypes.push_back("crescent");
	LayerParams_shapeTypes.push_back("squircle");
	LayerParams_shapeTypes.push_back("capsule");
	LayerParams_shapeTypes.push_back("teardrop");
	LayerParams_shapeTypes.push_back("gear");
	LayerParams_shapeTypes.push_back("pacman");
	LayerParams_shapeTypes.push_back("rose");
	LayerParams_shapeTypes.push_back("spirograph");
	LayerParams_shapeTypes.push_back("lissajous");
	LayerParams_shapeTypes.push_back("spiral");
	LayerParams_shapeTypes.push_back("logspiral");
	LayerParams_shapeTypes.push_back("blob");
	LayerParams_shapeTypes.push_back("zigzag");
	LayerParams_shapeTypes.push_back("wave");
	LayerParams_shapeTypes.push_back("burst");
	LayerParams_shapeTypes.push_back("concentric");
	LayerParams_shapeTypes.push_back("ring");
	LayerParams_shapeTypes.push_back("arc");
