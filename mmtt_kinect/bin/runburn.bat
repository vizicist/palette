...
start c:/local/manifold/patches/bidule/Palette_Alchemy_Burn.bidule
sleep 25
sleep 20

set patches=c:\local\manifold\src\manifold_bm\Binaries\win32\Manifold\patches
copy %patches%\default_burn.mnf %patches%\default.mnf
...
rem cd C:\Program Files (x86)\Resolume Avenue 4.0.1
