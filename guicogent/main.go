...
// 	// b.RunMainWindow()
// 	app := core.NewApp("MyApp", "My Application")
// 	win := app.NewMainWindow("mainWindow", "Main Window", 800, 600) // Default size
//
// 	// Set specific geometry (position and size)
// 	win.SetGeometry(false, image.Pt(100, 100), image.Pt(1024, 768), 0)
//
// 	win.StartEventLoop()
// }
...
func textEditors(ts *core.Tabs) {
	...
	errors.Log(texteditor.NewEditor(sp).Buffer.OpenFS(demoFile, "main.go"))
