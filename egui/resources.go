...
func newListResources(fonts *fonts) (*listResources, error) {
	idle, err := imageFromFile("graphics/list-idle.png")
	if err != nil {
		return nil, err
	}

	disabled, err := imageFromFile("graphics/list-disabled.png")
	if err != nil {
		return nil, err
	}

	mask, err := imageFromFile("graphics/list-mask.png")
	if err != nil {
		return nil, err
	}

	trackIdle, err := imageFromFile("graphics/list-track-idle.png")
	if err != nil {
		return nil, err
	}

	trackDisabled, err := imageFromFile("graphics/list-track-disabled.png")
	if err != nil {
		return nil, err
	}

	handleIdle, err := imageFromFile("graphics/slider-handle-idle.png")
	if err != nil {
		return nil, err
	}

	handleHover, err := imageFromFile("graphics/slider-handle-hover.png")
	if err != nil {
		return nil, err
	}
...
func newSliderResources() (*sliderResources, error) {
	idle, err := imageFromFile("graphics/slider-track-idle.png")
	if err != nil {
		return nil, err
	}

	disabled, err := imageFromFile("graphics/slider-track-disabled.png")
	if err != nil {
		return nil, err
	}
	...
	handleDisabled, err := imageFromFile("graphics/slider-handle-disabled.png")
	if err != nil {
		return nil, err
	}
...
func newTextInputResources(fonts *fonts) (*textInputResources, error) {
	idle, err := imageFromFile("graphics/text-input-idle.png")
	if err != nil {
		return nil, err
	}

	disabled, err := imageFromFile("graphics/text-input-disabled.png")
	if err != nil {
		return nil, err
	}
...
func newToolTipResources(fonts *fonts) (*toolTipResources, error) {
	bg, err := imageFromFile("graphics/tool-tip.png")
	if err != nil {
		return nil, err
	}
